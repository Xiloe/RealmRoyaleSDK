...
// ScriptStruct GFxUI.GFxObject.GFxObjectPoolEntry
// 0x0028
struct FGFxObjectPoolEntry
{
	unsigned long                                      bActive : 1;                                              // 0x0000(0x0004)
	struct FString                                     sSymbolName;                                              // 0x0004(0x0010) (NeedCtorLink)
	unsigned char                                      byTypeId;                                                 // 0x0014(0x0001)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0015(0x0003) MISSED OFFSET
	class UClass*                                      pType;                                                    // 0x0018(0x0008)
	class UGFxObject*                                  pObj;                                                     // 0x0020(0x0008)
};
