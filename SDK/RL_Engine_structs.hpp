...
struct FImpactInfo
{
	...
	int                                                nFiringInstance;                                          // 0x0078(0x0004) (AlwaysInit)
	unsigned char                                      nShotsHit;                                                // 0x007C(0x0001) (AlwaysInit)
};
...
struct FNavMeshPathParams
{
	...
	unsigned long                                      bCanMantle : 1;                                           // 0x0008(0x0004) (Edit)
	unsigned long                                      bNeedsMantleValidityTest : 1;                             // 0x0008(0x0004) (Edit)
	unsigned long                                      bAbleToSearch : 1;                                        // 0x0008(0x0004) (Edit)
	struct FVector                                     SearchExtent;                                             // 0x000C(0x000C) (Edit)
	float                                              SearchLaneMultiplier;                                     // 0x0018(0x0004) (Edit)
	struct FVector                                     SearchStart;                                              // 0x001C(0x000C) (Edit)
	float                                              MaxDropHeight;                                            // 0x0028(0x0004) (Edit)
	float                                              MinWalkableZ;                                             // 0x002C(0x0004) (Edit)
	float                                              MaxHoverDistance;                                         // 0x0030(0x0004) (Edit)
	float                                              MaxPathLength;                                            // 0x0034(0x0004) (Edit)
};
...
struct FAimOffsetProfile
{
	...
	struct FVector2D                                   AdditionalAimOffset;                                      // 0x0028(0x0008) (Edit)
	struct FName                                       AnimName_LU;                                              // 0x0030(0x0008) (Edit)
	struct FName                                       AnimName_LC;                                              // 0x0038(0x0008) (Edit)
	struct FName                                       AnimName_LD;                                              // 0x0040(0x0008) (Edit)
	struct FName                                       AnimName_CU;                                              // 0x0048(0x0008) (Edit)
	struct FName                                       AnimName_CC;                                              // 0x0050(0x0008) (Edit)
	struct FName                                       AnimName_CD;                                              // 0x0058(0x0008) (Edit)
	struct FName                                       AnimName_RU;                                              // 0x0060(0x0008) (Edit)
	struct FName                                       AnimName_RC;                                              // 0x0068(0x0008) (Edit)
	struct FName                                       AnimName_RD;                                              // 0x0070(0x0008) (Edit)
};
...
{
	struct FQWord                                      SkelMeshRUID;                                             // 0x0000(0x0008)
